...
docker build -t ${ACCOUNT}.dkr.ecr.us-east-1.amazonaws.com/interop/sandbox-manager-prototype:latest .
...
docker push ${ACCOUNT}.dkr.ecr.us-east-1.amazonaws.com/interop/sandbox-manager-prototype:latest
